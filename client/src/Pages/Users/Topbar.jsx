...
const Topbar = ({ view, setView, setIsFiltered, isFiltered }) => {
  ...
  ///////////////////////////////////////// USE EFFECTS ///////////////////////////////////////////////////
  useEffect(() => {
    if (openEmployeeModal || openClientModal) {
      const { current: descriptionElement } = descriptionElementRef;
      if (descriptionElement != null) {
        descriptionElement.focus();
      }
    }
  }, [openEmployeeModal, openClientModal]);
  ...
  const handleCreateEmployeeOpen = (scrollType) => () => {
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <Tooltip title="Add New Employee" placement="top" arrow>
                <div onClick={handleCreateEmployeeOpen("body")}>
